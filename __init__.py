from nytimes_scraper.src.scraper.scraper import Scraper as __Scraper
from nytimes_scraper.src import entities
from nytimes_scraper.src import exceptions

# Puedes importar más elementos aquí si lo deseas
